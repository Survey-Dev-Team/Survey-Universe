package com.survey.universe.api.spring.filter;
...
import com.survey.universe.api.spring.util.JwtAuthorizationHeaderUtil;
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (jwtTokenUtil.validateAccessToken(token)) {
			...
			if (user.isPresent()) {
				...
				List<SimpleGrantedAuthority> authorities = List.of(new SimpleGrantedAuthority(userRecord.getRole()));
