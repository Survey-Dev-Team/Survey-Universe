...
@Component({
  selector: 'gt-survey-select-radio',
  imports: [],
  templateUrl: './survey-select-radio.html',
  styleUrl: './survey-select-radio.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { style: 'display:flex; flex-direction:column; gap:8px' },
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SurveySelectRadioElement),
      multi: true,
    },
  ],
})
export class SurveySelectRadioElement implements ControlValueAccessor {
