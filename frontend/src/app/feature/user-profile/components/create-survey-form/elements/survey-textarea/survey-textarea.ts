...
@Component({
  selector: 'gt-survey-textarea',
  imports: [],
  templateUrl: './survey-textarea.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { style: 'display:flex; flex-direction:column; gap:8px' },
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SurveyTextareaElement),
      multi: true,
    },
  ],
})
export class SurveyTextareaElement implements ControlValueAccessor {
